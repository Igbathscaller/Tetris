...
public class SpinSpin implements Type{
  ...
  public void initialize(){
    ...
    blocks[8] = loadImage("Assets/G.png");
    
    int[] line1 = {8,8,8,8,0,0,8,8,8,8};
    int[] line2 = {8,8,8,8,8,0,0,8,8,8};
    int[] line3 = {8,8,8,8,0,0,8,8,8,8};
    int[] line4 = {8,8,8,0,0,8,8,8,8,8};
    int[] line5 = {8,8,8,0,0,0,0,8,8,8};
  ...
  private void setPiece(){
      ...
      piece = new Piece(start[now],board);
      shadowPiece = piece.shadowPiece(0,0);
      canHold = true;
